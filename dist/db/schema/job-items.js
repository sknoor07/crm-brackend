...
export const jobItems = pgTable('job_items', {
    ...
    assignedRepairPersonId: uuid('assigned_repair_person_id')
        .references(() => users.id),
    estimatedComponentsCost: decimal('estimated_components_cost', {
        precision: 10,
        scale: 2,
    }),
    finalComponentsCost: decimal('final_components_cost', {
        precision: 10,
        scale: 2,
    }),
    serviceChargeApplied: decimal('service_charge_applied', {
        precision: 10,
        scale: 2,
    }),
    ...
    baseRepairCost: decimal('base_repair_cost', {
        precision: 10,
        scale: 2,
    }),
