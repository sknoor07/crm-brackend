...
import { customerProfiles, deviceServiceCharges, employeeProfiles, roles, userRoles, users, } from './schema/index.js';
...
const seed = async () => {
    await db.transaction(async (tx) => {
        ...
        for (const userSeed of userSeeds) {
            ...
            if (!roleId) {
                throw new Error(`Role was not seeded: ${userSeed.role}`);
            }
