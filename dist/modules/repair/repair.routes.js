...
import { getPendingRepairAssignments, assignRepairPerson, getAssignedRepairItems, 
//startDiagnosis,
requestFinalQuote, 
// startRepair,
//completeRepair,
getPendingRepairInspections, approveRepair, 
//rejectRepairInspection,
getAllRepairPersons, } from './repair.controller.js';
import { assignRepairPersonSchema, requestFinalQuoteSchema, approveRepairSchema, } from './repair.validation.js';
 ...
 */
router.get('/pending-assignment', requireRole(repairManagerRoles), getPendingRepairAssignments);
 ...
 * PATCH /repair/assign
 */
router.patch('/assign', requireRole(repairManagerRoles), validateRequest(//check
assignRepairPersonSchema), assignRepairPerson);
///////////////////////////////////////////////done///////////////////////////////////////
/////////////////////////////////////////Pending/////////////////////////////////////////
/**
 ...
 */
router.get('/pending-inspection', requireRole(repairManagerRoles), getPendingRepairInspections);
/**
 * Approve a completed repair.
 *
 * PATCH /repair/approve
 */
router.patch('/approve', requireRole(repairManagerRoles), validateRequest(approveRepairSchema), approveRepair);
/**
 ...
 * GET /repair/my-items
 */
router.get('/my-items', requireRole(repairPersonRoles), getAssignedRepairItems);
///////////////////////////////////////////////////////////done /////////////////////////////////////////////////////
/////////////////////////////////////////////////////pending////////////////////////////////////////////////////
/**
 * Start diagnosis.
 ...
 */
router.patch('/request-final-quote', requireRole(repairPersonRoles), validateRequest(// check
requestFinalQuoteSchema), requestFinalQuote);
/**
