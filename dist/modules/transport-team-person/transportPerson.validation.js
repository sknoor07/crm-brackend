...
export const completeTransportInspectionSchema = z.object({
    ...
    items: z
        ...
        .min(1, 'At least one item inspection is required'),
});
...
export const generateFinalQuoteSchema = z.object({
    ...
    items: z.array(z.object({
        ...
        components: z
            ...
            quantity: z
                .number()
                .positive('Component quantity must be greater than 0'),
            unitPrice: z
                .number()
                .nonnegative('Component unit price cannot be negative'),
        }))
            .default([]),
        /**
     ...
     */
    removedItemIds: z
        .array(z.string().uuid('Invalid job item ID format'))
        .default([]),
    /**
