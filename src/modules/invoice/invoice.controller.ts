...
import { InvoicePdfData } from "./invoice-pdf.types.js";
import { Request, Response } from "express";
import { createPdfDownloadUrl } from "../storage/storage.service.js";

export const getInvoicePdfData = async (
  invoiceId: string,
